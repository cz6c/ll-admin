...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('1', '系统管理', '0', '1', 'system',           null, '', 1, 0, 'C', '0', '0', '', 'system',   'admin', sysdate(), '', null, '系统管理目录', '0');
insert into sys_menu values('2', '系统监控', '0', '2', 'monitor',          null, '', 1, 0, 'C', '0', '0', '', 'monitor',  'admin', sysdate(), '', null, '系统监控目录', '0');
