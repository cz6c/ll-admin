...
import { CreatePushTaskDto, ListPushTaskDto, PushTaskVO, PushTaskChangeStatusDto } from "./dto/index";
...
export class PushTaskController {
  ...
  @ApiBody({ type: PushTaskChangeStatusDto })
  @ApiResult()
  @Post("/switchStatus")
  switchStatus(@Body() data: PushTaskChangeStatusDto, @GetRequestUser("user") user: RequestUserPayload["user"]) {
