...
export class UserEntity extends BaseEntity {
  ...
  @Column({ type: 'varchar', name: 'user_name', length: 50, comment: '用户账号' })
  public userName: string;

  @Column({ type: 'varchar', name: 'nick_name', length: 50, comment: '用户昵称' })
  ...
  @Column({ type: 'enum', enum: UserSexEnum, default: UserSexEnum.UNKNOWN, name: 'sex', comment: '性别' })
