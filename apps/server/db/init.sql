...
CREATE TABLE
  ...
  ) ENGINE = InnoDB AUTO_INCREMENT = 1100 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表';
...
VALUES
  ...
  -- 二级页按钮权限 F（perm 与前端 authCode 对齐）
  (
    '0',
    '0',
    1,
...
CREATE TABLE
  `sys_role` (
    ...
    `data_scope` enum ('1', '2', '3', '4') COLLATE utf8mb4_general_ci NOT NULL DEFAULT '1' COMMENT '数据范围（1全部 2本部门 3本部门及以下 4仅本人）',
    `remark` varchar(500) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '备注',
    PRIMARY KEY (`role_id`)
...
CREATE TABLE
  `salary_verify_history` (
    ...
    `other_deduction_amount` decimal(12, 2) NOT NULL DEFAULT '0.00' COMMENT '其他扣款（缺勤等，不含个税抵扣）',
    ...
    `inferred_pre_tax` decimal(12, 2) DEFAULT NULL COMMENT '反推申报应发（用户确认后落库）',
    `report_bias` enum ('under', 'over') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '申报偏差：under少报/over多报',
    `use_inferred_for_cumulative` tinyint (1) NOT NULL DEFAULT '0' COMMENT '是否用反推应发参与后续累计预扣',
    PRIMARY KEY (`id`),
